...
(
  ...
  Street varchar(50) CHARACTER SET utf8mb4,
  HouseNr integer,
  ZipCode integer,
  Region integer,
  Country varchar(2)
...
(
  ...
  PRIMARY KEY (`CountryShort`)
);
ALTER TABLE Address
ADD FOREIGN KEY (ZipCode) REFERENCES ZipCode(ZipCode);
ALTER TABLE Address
ADD FOREIGN KEY (Region) REFERENCES Region(RegionID);
ALTER TABLE Address
ADD FOREIGN KEY (Country) REFERENCES Country(CountryShort);

insert into Region values(0, 'Undefined');

insert into Country(CountryShort, CountryLong, `de`, `es`, `fr`, `it`, `ru`) values
...
('XX', 'Undefinded', 'Undefinded', 'Undefinded', 'Undefinded', 'Undefinded', 'Undefinded');
